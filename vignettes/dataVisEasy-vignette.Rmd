...
Now that we've checked that our data looks alright, we can get off to making some plots! 
...
As with the PCA plots, the scatter plots can be colored by any available annotation or by the expression of any gene avaialble in the provided dataset
...
More customization are possible and there much more information about specific utilities in the help files. 
